...
downloaded
(`tardis-refdata <https://github.com/tardis-rt/tardis-refdata>`_).
...
.. warning::
    The `tests workflow <https://github.com/tardis-rt/tardis/blob/master/.github/workflows/tests.yml>`_ runs on 
...
main local `conftest <https://github.com/tardis-rt/tardis/blob/master/tardis/conftest.py>`_ file to get this to work.
...
You however need to provide the location to your snapshot directory using the ``--tardis-rtapshot-data`` flag.
The snapshots are also saved in `tardis-rt/tardis-regressions <https://github.com/tardis-rt/tardis-regressions>`_.
...
reference files (`here <https://github.com/tardis-rt/tardis-refdata>`_)
